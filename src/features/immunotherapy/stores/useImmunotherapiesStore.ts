...
const DEFAULT_IMMUNOTHERAPIES: Immunotherapy[] = [
  ...
  { id: '7', name: 'Marta Gabriela de Sousa', phone: '(62) 98213-9054', type: 'Gramíneas', doseConcentration: '1:10 - 0,5ml', cycleInterval: { number: 3, days: 28 }, modality: 'subcutaneous', status: 'active', completed: false, responsibleDoctor: 'Dr. André Lima' },
