...
const patientProfiles: Record<string, PatientProfile> = {
  '1':  { birthDate: '15/04/2007', age: 18, cpf: '124.583.706-42', weight: '52.3 kg', extract: '', targetConcentrationVolume: '', targetReached: false },
  '2':  { birthDate: '22/11/1992', age: 33, cpf: '587.291.034-18', weight: '64.0 kg', extract: '', targetConcentrationVolume: '', targetReached: false },
  '3':  { birthDate: '08/07/2015', age: 10, cpf: '091.847.563-25', weight: '32.5 kg', extract: '', targetConcentrationVolume: '', targetReached: false },
  '4':  { birthDate: '30/01/1998', age: 28, cpf: '304.715.689-50', weight: '58.7 kg', extract: '', targetConcentrationVolume: '', targetReached: false },
  '5':  { birthDate: '12/09/1985', age: 40, cpf: '762.408.193-77', weight: '78.2 kg', extract: '', targetConcentrationVolume: '', targetReached: true },
  '6':  { birthDate: '03/03/1990', age: 36, cpf: '489.230.671-04', weight: '61.4 kg', extract: '', targetConcentrationVolume: '', targetReached: true },
  '7':  { birthDate: '25/06/1972', age: 53, cpf: '138.594.726-91', weight: '69.0 kg', extract: '', targetConcentrationVolume: '', targetReached: true },
  '8':  { birthDate: '14/10/1988', age: 37, cpf: '851.327.460-66', weight: '81.5 kg', extract: '', targetConcentrationVolume: '', targetReached: false },
  '9':  { birthDate: '18/02/2010', age: 16, cpf: '290.418.357-13', weight: '47.8 kg', extract: '', targetConcentrationVolume: '', targetReached: false },
  '10': { birthDate: '27/05/1995', age: 30, cpf: '643.715.802-39', weight: '72.6 kg', extract: '', targetConcentrationVolume: '', targetReached: false },
  '11': { birthDate: '09/12/1989', age: 36, cpf: '405.286.913-58', weight: '65.9 kg', extract: '', targetConcentrationVolume: '', targetReached: true },
  '12': { birthDate: '05/08/1968', age: 57, cpf: '917.052.864-21', weight: '89.3 kg', extract: '', targetConcentrationVolume: '', targetReached: false },
}
