...
export const useSettingsStore = create<SettingsState>()(
  persist(
    ...
    {
      name: 'imunecare:settings',
      // Persiste apenas os valores de dados, não as funções setter (Zustand já reconstrói os setters)
      partialize: (state) => ({
        ...
        reminderWhatsapp: state.reminderWhatsapp,
