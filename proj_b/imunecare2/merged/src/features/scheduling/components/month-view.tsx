                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        application.status === 'completed' && 'opacity-60',
                      )}
                      style={{
                        backgroundColor: application.status === 'missed' ? '#FEF2F2' : color.bg,
                        color: application.status === 'missed' ? '#991B1B' : color.text,
                        borderLeftColor: application.status === 'missed' ? '#EF4444' : color.border,
                      }}
                    >
